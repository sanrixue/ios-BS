...
- (void)setUpUI {
    ...
    [self.time mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.context.mas_bottom).offset(10);
...
- (void)setNewsModel:(NewsModel *)NewsModel {
    ...
    [self.icon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:Main_URL,_newsModel.icon]]];
    
    self.title.text = _newsModel.title;
    
    self.context.text = _newsModel.content;
    
    self.time.text = [self compareCurrentTime:_newsModel.start_time];
