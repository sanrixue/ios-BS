...
- (void)setImageNameArray:(NSMutableArray *)imageNameArray
{
    ...
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:Main_URL,_imageNameArray[1][@"banner"]]]];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:Main_URL,_imageNameArray[(currentImage)%_imageNameArray.count][@"banner"]]]];
    
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:Main_URL,_imageNameArray[(currentImage+1)%_imageNameArray.count][@"banner"]]]];
