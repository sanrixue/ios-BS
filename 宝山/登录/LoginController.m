...
- (void)setUpUI {
    ...
    [creatControls text:_phone Title:@"账号" Frame:CGRectMake(KSCREENWIDTH * 0.15,  KSCREENHEIGHT* 0.35, KSCREENWIDTH * 0.7, 35)];
    ...
    UILabel *line = [[UILabel alloc] initWithFrame:CGRectMake(KSCREENWIDTH * 0.25,  KSCREENHEIGHT* 0.45 + 197 + 30, KSCREENWIDTH * 0.12, 1)];
    line.backgroundColor = [UIColor whiteColor];
    [self.view addSubview:line];

    UILabel *line2 = [[UILabel alloc] initWithFrame:CGRectMake(KSCREENWIDTH * 0.63,  KSCREENHEIGHT* 0.45 + 197 + 30, KSCREENWIDTH * 0.12, 1)];
    line2.backgroundColor = [UIColor whiteColor];
    [self.view addSubview:line2];

    UIButton *PUTBtn2 = [[UIButton alloc] init];
    PUTBtn2.frame = CGRectMake(KSCREENWIDTH * 0.35,  KSCREENHEIGHT* 0.45 + 180 + 30, KSCREENWIDTH * 0.3, 35);
    ...
    PUTBtn2.userInteractionEnabled = NO;
    
    
    UIButton *QQ = [[UIButton alloc] init];
    QQ.frame = CGRectMake(KSCREENWIDTH * 0.25,  KSCREENHEIGHT* 0.45 + 220 + 30, 40, 40);
    ...
    WX.frame = CGRectMake(KSCREENWIDTH * 0.5-20,  KSCREENHEIGHT* 0.45 + 220 + 30, 40, 40);
    ...
    XL.frame = CGRectMake(KSCREENWIDTH * 0.75-40,  KSCREENHEIGHT* 0.45 + 220 + 30, 40, 40);
...
- (void)PUTBtnClick {
    ...
    else
    {
            ...
            {
                NSDictionary * PostDic = @{@"name":_phone.text,@"pwd":_password.text};
